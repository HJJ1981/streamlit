...
st.title("Simple Interest Calculator for High Yields Savings Plus Accounts")

# Description
st.write("""
This calculator estimates the simple interest earned based on deposit balance in High Yields Savings Plus Account over a specified period of time. 
